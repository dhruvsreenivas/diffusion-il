...
class Discriminator(nn.Module):
    """Discriminator network. Takes states and actions as input."""
    ...
    def forward(self, cond: Union[dict, torch.Tensor], action: torch.Tensor):
        """
...
class ViTDiscriminator(Discriminator):
    """ViT + MLP, state-action input."""
