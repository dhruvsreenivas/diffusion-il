"""
Parent GAIL imitation-based agent class.
...
from agent.imitation.train_agent import ImitationAgent
from util.reward_scaling import RunningRewardScaler


class TrainGAILAgent(ImitationAgent):
    ...
    def __init__(self, cfg):
        ...
        self.discriminator_lr_scheduler = CosineAnnealingWarmupRestarts(
            ...
            first_cycle_steps=cfg.train.discriminator_lr_scheduler.first_cycle_steps,
            cycle_mult=1.0,
            max_lr=cfg.train.discriminator_lr,
            min_lr=cfg.train.discriminator_lr_scheduler.min_lr,
            warmup_steps=cfg.train.discriminator_lr_scheduler.warmup_steps,
            gamma=1.0,
        )
