"""
Diffusion GAIL for pixel observations.
...
class TrainGAILImgDiffusionAgent(TrainGAILDiffusionAgent):
    ...
    def run(self):
        ...
        while self.itr < self.n_train_itr:
            ...
            for step in range(self.n_steps):
                ...
                # log whole predicted action chunk instead of just what was executed
                actions_trajs[step] = output_venv
